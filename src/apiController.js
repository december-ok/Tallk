...
export const getUser = async (userId) => {
	...
	const { data } = await axios.get(message + userId, { withCredentials: true });
	return data;
};
...
export const getChatRoom = async ({ roomId, from, amount }) => {
	...
	const { data } = await axios.get(message, { withCredentials: true });
	return data;
};
...
export const getUserEmail = async (email) => {
	...
	const { data } = await axios.get(message + email, { withCredentials: true });
	return data;
};
